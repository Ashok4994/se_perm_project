    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "update employee "
                    + "set firstname= '" + request.getParameter("fname").trim() + "', "
                    + "set lastname= '" + request.getParameter("lname").trim() + "', "
                    + "set address= '" + request.getParameter("address").trim() + "', "
                    + "`phone`='" + request.getParameter("mobile_number").trim() + "', "
                    + "`email`='" + request.getParameter("email-id").trim() + "', "
