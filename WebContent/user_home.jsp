...
<link href="http://fontawesome.io/assets/font-awesome/css/font-awesome.css" rel="stylesheet" media="screen">	
 ...
 <li><a href="<%=request.getContextPath()%>/update_profile.jsp" class="col-xs-24">Update Profile</a></li>
             ...
             <div id="create-user" class="row">
                        <div class="widget widget-gray"> <!-- TYPE PANEL -->
                            <div class="widget-head"> <!-- HEAD PANEL -->
                                <h4 class="heading"><i class="fa fa-briefcase"> </i> Request Leave</h4>
                            </div><!-- /HEAD PANEL -->
                                ...
                                <form class="form-horizontal" method="post" action="Leave">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="gender">Start Date</label>  
                                            <div class="col-md-4">
                                                <input id="name" name="sdate" placeholder="" class="form-control input-md" required="true" type="date">
                                            </div>
                                        </div>

                                        <!-- Text input-->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="gender">End Date</label>  
                                            <div class="col-md-4">
                                                <input id="gender" name="enddate" placeholder="" class="form-control input-md" required="true" type="date">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="phone">Reason</label>  
                                            <div class="col-md-4">
                                                <input id="phone" name="reason" placeholder="" class="form-control input-md" required="true" type="text" >
                                            </div>
                                        </div>
                            ...
                            <div class="widget-footer"><!-- FOOTER PANEL--> 
                                ...
                                <a href="#" id="toggle1" class="fa fa-chevron-down fa-1x" data-toggle="tooltip" data-placement="right" title="" data-original-title="FA-PLUS-CIRCLE"><i></i></a>
                            </div><!-- /FOOTER PANEL--> 
