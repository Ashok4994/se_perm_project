...
public class Upload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(session != null){
			...
			ResultSet rs2 = stmt.executeQuery("SELECT * from directory where manager_id=" + m_id + "");
				   //out.println("after rs2");
				    if (rs2.next()) {
	            ...
	            String sql = "INSERT INTO files(dir_id, title, file,type) values (?,?,?,?)";
